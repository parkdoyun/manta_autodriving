...
(cl:defmethod cl:initialize-instance :after ((m <student>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'student)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name manta-msg:<student> is deprecated: use manta-msg:student instead.")))

(cl:ensure-generic-function 'first_name-val :lambda-list '(m))
(cl:defmethod first_name-val ((m <student>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader manta-msg:first_name-val is deprecated.  Use manta-msg:first_name instead.")
  (first_name m))

(cl:ensure-generic-function 'last_name-val :lambda-list '(m))
(cl:defmethod last_name-val ((m <student>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader manta-msg:last_name-val is deprecated.  Use manta-msg:last_name instead.")
  (last_name m))

(cl:ensure-generic-function 'age-val :lambda-list '(m))
(cl:defmethod age-val ((m <student>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader manta-msg:age-val is deprecated.  Use manta-msg:age instead.")
  (age m))

(cl:ensure-generic-function 'score-val :lambda-list '(m))
(cl:defmethod score-val ((m <student>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader manta-msg:score-val is deprecated.  Use manta-msg:score instead.")
  (score m))
